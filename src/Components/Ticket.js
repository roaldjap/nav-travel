    ...
    return (
      <div class="ticket-wrapper">
          ...
          <div className="ticket">
            ...
            <div className={`rip ${this.props.details.products[0].status === "Sold Out" ? "hide-bottom" : ""}`}></div>
            {this.props.details.products[0].status === "Last Spaces" ? (
              <div className="ticket-footer last-spaces">
                <p class="status">{this.props.details.products[0].status}</p>
              </div>
          ...
          <div className="ticket">
            ...
            <div className={`rip ${this.props.details.products[1].status === "Sold Out" ? "hide-bottom" : ""}`}></div>
            {this.props.details.products[1].status === "Last Spaces" ? (
              <div className="ticket-footer last-spaces">
                <p class="status">{this.props.details.products[1].status}</p>
              </div>
          ...
          <div className="ticket">
            ...
            <div className={`rip ${this.props.details.products[2].status === "Sold Out" ? "hide-bottom" : ""}`}></div>
            {this.props.details.products[2].status === "Last Spaces" ? (
              <div className="ticket-footer last-spaces">
                <p class="status">{this.props.details.products[2].status}</p>
              </div>
